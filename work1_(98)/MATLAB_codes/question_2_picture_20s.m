...
opts.Sheet = "线圈数据20s";
opts.DataRange = "A2:D12961";
opts.VariableNames = ["Var1", "Var2", "Var3", "FINT_VOLUMEveh20s"];
opts.SelectedVariableNames = "FINT_VOLUMEveh20s";
...
tbl = readtable("ans_1.xlsx", opts, "UseExcel", false);
q = tbl.FINT_VOLUMEveh20s;
clear opts tbl
% 导入数据v
opts = spreadsheetImportOptions("NumVariables", 5);
opts.Sheet = "线圈数据20s";
opts.DataRange = "A2:E12961";
