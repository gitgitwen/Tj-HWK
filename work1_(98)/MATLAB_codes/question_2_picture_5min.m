...
opts.Sheet = "线圈数据5min";
opts.DataRange = "A2:D862";
opts.VariableNames = ["Var1", "Var2", "Var3", "FINT_VOLUMEveh5min"];
opts.SelectedVariableNames = "FINT_VOLUMEveh5min";
...
q = tbl.FINT_VOLUMEveh5min;
clear opts tbl
opts = spreadsheetImportOptions("NumVariables", 5);
opts.Sheet = "线圈数据5min";
opts.DataRange = "A2:E862";
